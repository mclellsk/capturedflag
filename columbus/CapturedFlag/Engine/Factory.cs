...
namespace CapturedFlag.Engine
{
    public class Factory : Entity
    {
        ...
        public int ActiveSpawn
        {
            get
            {
                return activeObjects.Count;//pool.objects.FindAll(p => p.activeSelf).Count;
            }
        }
        ...
        public virtual void InitializeObject(GameObject obj)
        {
            ...
            //Set Ownership
            obj.BroadcastMessage("CopyID", this.MyID, SendMessageOptions.DontRequireReceiver);
        }
