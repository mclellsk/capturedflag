...
namespace CapturedFlag.Engine
{
    ...
    public class ViewManager : MonoBehaviour
    {
        ...
        /// </summary>
        private static List<ViewScreen> viewOrder = new List<ViewScreen>();

        /// <summary>
        /// All available screens in the scene.
        /// </summary>
        public static Dictionary<string, ViewScreen> views = new Dictionary<string, ViewScreen>();
        ...
        private void Awake()
        {
            ...
            //Get all screens
            views.Clear();
            var v = (ViewScreen[])Resources.FindObjectsOfTypeAll(typeof(ViewScreen));
        ...
        private static void Show(ViewScreen view)
        {
            if (view != null)
            {
                ...
                LogTool.LogError("View does not exist.");
        }
        ...
        private static void Hide(ViewScreen view)
        {
            if (view != null)
            {
                if (view.gameObject.activeSelf)
        ...
        {
            foreach (ViewScreen v in viewOrder)
            {
                Hide(v);
            }
        }
